...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "AV DYNAMICS PRIVATE LIMITED" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "AV DYNAMICS PRIVATE LIMITED" },
      {
        ...
        content: "Room-by-room construction progress, issues and site photos.",
      },
    ...
    links: [
      ...
      { rel: "icon", href: "src/assets/AV DYNAMICS PRIVATE LIMITED LOGO.png", type: "image/png" },
    ],
  }),
